...
if __name__ == "__main__":
    model_path = r"../chosen_iris_authentication_model.keras"
    result_file = "test_results.txt"
    model = load_model(model_path)

    # Hardcoded paths for the test
    img1_path = r"C:\Code\Biometric\iris-authentication\captured\Screenshot 2024-12-25 160055.png"
    img2_path = r"C:\Code\Biometric\iris-authentication\database_images\test\Screenshot 2024-12-25 160055.png"
    expected_match = False  # Change to True if these images are expected to match

    correct_predictions = 0
    total_cases = 1  # Only one test case
